...
- The header should dynamically match the width of the Box 1/Box 2 container
- Include minimal styling to make the boxes visible (borders, padding, background colors)
- Use semantic HTML

## Example breakpoint behavior:
- Wide screens: Header spans full width, Box 1 and Box 2 side-by-side (each up to 700px)
- Narrow screens: Header matches box width, Box 1 and Box 2 stack vertically (each up to 700px but responsive to viewport)
